...
import locationIcon from "../../../assets/dashboard/MapPin.svg"
import trashIcon from "../../../assets/company/TrashIcon.png"
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-1">
            <img src={locationIcon} alt="Location" className="w-[18px] h-[18px]" />
