    ...
    return (
        <div className="min-h flex">
            ...
            <div className="w-1/2 flex flex-col px-12 py-8">
                ...
                <div className="flex-1 flex flex-col justify-center max-w-xl w-xl ml-7">
                    {/* Email Field */}
                    <p className='font-medium text-2xl mb-16 mt-6'>Cùng Rikkei Education xây dựng hồ sơ nổi bật và nhận được các cơ hội sự nghiệp lý tưởng</p>
                    <div className="mb-12">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-6 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                    ...
                    <div className="mb-12">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 py-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                                placeholder="**************"
                            />
                            <button
                                type="button"
